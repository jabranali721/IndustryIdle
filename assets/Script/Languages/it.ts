export const IT = {
    ...
    PlayerTradeTradeValueAfterTax: "Valore Scambio Dopo Tassa",
    PlayerTradeShowTaxCalculation: "Mostra Calcolo Tassa",
    PlayerTradeHideTaxCalculation: "Nascondi Calcolo Tassa",
    PlayerTradeMaxTaxCreditValue: "Set Amount to Match Tax Credit",
    WaterProductionx2: "Super Pompa d'Acqua",
    WaterProductionx2Desc: "Le Pompe d'Acqua Producono 2x Ma consumano 2x di corrente",
